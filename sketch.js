...
function draw() {
  ...
  if (gameState==="wait"){
    ...
    title1.html("Kill your fears before they kill you")
    title1.position(500,100)
    title1.style("color", "white")

    title2.html("Are you ready to overcome your fears?")
    title2.position(500,400)
    title2.style("color", "white")

    title3.html("If yes click on the button")
    title3.position(500,500)
    title3.style("color", "white")

    button=createButton("Kill em")
